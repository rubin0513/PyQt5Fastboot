...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(340, 10, 370, 42))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(320, 620, 411, 61))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(340, 60, 233, 204))
        ...
        self.widget.setGeometry(QtCore.QRect(170, 270, 716, 344))
        ...
        self.label_splash = QtWidgets.QLabel(self.widget)
        ...
        self.lineEdit_splash = QtWidgets.QLineEdit(self.widget)
        ...
        self.button_burn_splash = QtWidgets.QPushButton(self.widget)
    ...
    def lj_flash_splash(self):
        ...
        if(flag == True):
            QtWidgets.QMessageBox.critical(self.button_burn_splash,common.BURNERROR,"otaloader烧录失败")
        else:
            QtWidgets.QMessageBox.information(self.button_burn_splash,common.BURNSUCCESS,"otaloader烧录成功")
